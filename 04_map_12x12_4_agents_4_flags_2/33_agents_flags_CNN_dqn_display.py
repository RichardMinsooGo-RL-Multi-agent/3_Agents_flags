...
class Agents_Flags:
    ...
    def reset_env(self):
        ...
        self.agent_rows = [5,5,6,6]
        self.agent_cols = [5,6,5,6]
...
def main():
    ...
    if load_model:
        agnt_0.model.load_weights(model_path + "/Model_dqn_0.h5")
        agnt_1.model.load_weights(model_path + "/Model_dqn_1.h5")
        agnt_2.model.load_weights(model_path + "/Model_dqn_2.h5")
        agnt_3.model.load_weights(model_path + "/Model_dqn_3.h5")
    ...
    while agnt_0.episode < 5:
        ...
        g_agent = pygame.image.load("./images/g_agent.jpg")
        fig_2 = pygame.transform.scale(g_agent, (60, 60))
        
        g_agent_agent = pygame.image.load("./images/g_agent_agent.jpg")
        fig_4 = pygame.transform.scale(g_agent_agent, (60, 60))
        
        g_agent_agent_landmark = pygame.image.load("./images/g_agent_agent_landmark.jpg")
        fig_5 = pygame.transform.scale(g_agent_agent_landmark, (60, 60))
        
        g_agent_landmark = pygame.image.load("./images/g_agent_landmark.jpg")
        fig_3 = pygame.transform.scale(g_agent_landmark, (60, 60))
        
        g_landmark = pygame.image.load("./images/g_landmark.jpg")
        fig_1 = pygame.transform.scale(g_landmark, (60, 60))
        ...
        while not done and ep_step < agnt_0.ep_trial_step:
            ...
            for row_idx in range(8):
                for col_idx in range(8):
                    if game_arr[row_idx+1][col_idx+1] == 1:
                        SURFACE.blit(fig_1, (60*(row_idx+1), 60*(col_idx+1)))
                    if game_arr[row_idx+1][col_idx+1] == 2:
                        SURFACE.blit(fig_2, (60*(row_idx+1), 60*(col_idx+1)))
                    if game_arr[row_idx+1][col_idx+1] == 3:
                        SURFACE.blit(fig_3, (60*(row_idx+1), 60*(col_idx+1)))
                    if game_arr[row_idx+1][col_idx+1] == 4:
                        SURFACE.blit(fig_4, (60*(row_idx+1), 60*(col_idx+1)))
                    if game_arr[row_idx+1][col_idx+1] == 5:
                        SURFACE.blit(fig_5, (60*(row_idx+1), 60*(col_idx+1)))
