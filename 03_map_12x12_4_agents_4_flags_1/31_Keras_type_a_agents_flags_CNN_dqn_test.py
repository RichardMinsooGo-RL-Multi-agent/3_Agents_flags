...
def main():
    ...
    agnt_0.model.save_weights(model_path + "/Model_dqn_0.h5")
    agnt_1.model.save_weights(model_path + "/Model_dqn_1.h5")
    agnt_2.model.save_weights(model_path + "/Model_dqn_2.h5")
    agnt_3.model.save_weights(model_path + "/Model_dqn_3.h5")
